...
import bgImageMobile from "../../../assets/photo/bg2_mobile_detailing.webp";
import bgImagePC from "../../../assets/photo/bg_detailing_pc.webp";
      ...
      <div className="relative z-20 px-6 pt-6 md:pt-[10vh] md:ml-15">
        ...
        <div className="mt-28 md:mt-32">
          ...
          <button
            ...
            className="text-base md:text-xl mt-10 px-12 py-4 rounded-full text-white font-semibold hover:opacity-90 transition"
