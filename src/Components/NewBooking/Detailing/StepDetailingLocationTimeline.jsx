...
const StepDetailingLocationTimeline = ({
  ...
  setServiceLocation,
  completionDate, // значення для DatePicker
  setCompletionDate,
  ...
  const canContinue = !!serviceLocation && !!completionDate;
        ...
        <section className="space-y-2">
          ...
          {!completionDate && (
            <p className="text-[12px] text-red-500 mt-1">
              Please select the preferred completion date.
            </p>
          )}

          <p className="text-[12px] sm:text-[13px] text-[#9CA3AF] mt-1">
            We&apos;ll do our best to accommodate your preferred date. Our team
