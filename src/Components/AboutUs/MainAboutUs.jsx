    ...
    <div className="bg-[rgba(235,235,235,1)] min-h-screen pb-8 relative">
      ...
      >
        ...
        >
          ...
          <span
            className="text-white text-[16px] sm:text-[18px] lg:text-[20px] font-semibold"
          >
            Lets is More
          </span>
        </div>
      ...
      {showPopup && (
        <div className="fixed inset-0 z-[200] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl w-full max-w-[900px] max-h-[85vh] overflow-y-auto p-8 shadow-2xl">
            ...
            <button
              onClick={closePopup}
              className="sticky top-0 ml-auto text-2xl font-semibold text-gray-600 hover:text-black bg-white p-2 rounded-full shadow z-50"
            >
              ✕
            </button>
            ...
            <p className="mb-3">
              ...
              operation to a full cleaning company...
            </p>

            <h3 className="text-2xl font-semibold mt-6 mb-3">Milestones of Perseverance</h3>
            ...
            <p className="mb-3">
              We know what it's like to start with nothing. We know the value of hard work, integrity...
            </p>
