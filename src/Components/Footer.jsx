...
const Footer = () => {
  ...
  // Перевірка чи це сторінка Detailing
  const isDetailingPage = location.pathname.startsWith("/services/detailing");

  // Вибір логотипу
  const logoSrc = isDetailingPage ? logoRed : logo;
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-14 items-start justify-between">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 lg:flex lg:flex-row lg:gap-20 flex-1 justify-between">
            ...
            <div className="flex flex-col gap-1">
              ...
              {["Home", "About Us", "Contact Form", "Newsletter"].map((text, i) => (
                <Link
                  key={i}
            ...
            <div className="flex flex-col gap-1">
              ...
              {["Privacy Policy", "Terms & Conditions", "FAQ"].map((text, i) => (
                <Link
                  key={i}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <img src={contactIcon2} alt="Phone Icon" className="w-5 h-5" />
                <a
              ...
              <div className="flex items-center gap-2">
                <img src={contactIcon1} alt="Email Icon" className="w-5 h-5" />
                <a
